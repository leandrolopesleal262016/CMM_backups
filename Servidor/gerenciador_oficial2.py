...
def thread_cadastro():
    ...
    def dataTransfer(conn):  # Loop de transferencia e recepcao de dados
        ...
        while True:
            ...
            if(op == "cadastrar_morador"): # Busca pelo ID no banco de dados e envia pro CMM correspondente

                print("\nreconheceu cadastrar morador\n")
                ...
                try:
                    ...
                    query = ("SELECT * FROM moradores")  # Seleciona a tabela qrcode
                    cursor.execute(query)
				...
				ds = str(ds)
                    ...
                    ####### PROCURA O ID CORRESPONDENTE NA LISTA #########
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        command = ("cadastrar_morador&" + cadastro) # Dados a serem enviados para o CLP correspondente
                                        ...
                                        print("\nNao conseguiu enviar acadstrar morador para o CMM\n", e)
                                        ...
                                        try:
                                            ...
                                            query = ("UPDATE moradores SET enviado = 1 WHERE ID = %s") %ID 
                                            cursor.execute(query)
                                            cnx.commit()
                    ...
                    print ("\nNao conseguiu cadastrar morador\n",e)
...
##                    break           
            ...
            if (op == "deletar_morador"):
                ...
                try:
                    ...
                    print("Dados recebidos no delete morador",data)
...
##                ########## CRIA WEBSOCKET E ENVIA OS DADOS PARA O CMM CORRESPONDENTE ########
                ...
                try:
                    ...
                    remover = ("deletar_morador&" + ID_recebido + ":" + cond)
                    remover = str(remover)
                    ...
                    print("\nNao conseguiu enviar delete morador para o CMM\n", e)

                    print("Colocando no buffer delete morador...")
...
#        encontramos = 0
#
#        query = ("SELECT * FROM moradores WHERE enviado = 0")  # Seleciona a tabela qrcode
#        cursor.execute(query)
#                            
#        for i in cursor:
#
...
#            if encontramos == 1:
#
#                print("\nEncontrou na tabela moradores cadastro ainda nao enviado")
#                
#                try:
#
#                    nome = str(nome)
...
#
#                                        arquivo = open("log_cmm.txt", "a+") # Escreve o evento no registro de log
#                                        arquivo.write(" Evento: Erro de acesso ao Banco por moradores " + err + "\n")
#                                        arquivo.close()
#                                                    
#                                        time.sleep(0.1)
#                                              
