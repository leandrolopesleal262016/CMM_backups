...
def Garagem2(Rele): # Inicia a thread do portão da garagem importando a classe Rele
    ...
    while(1):
        ...
        time.sleep(0.1)
        pmg2 = l.leitor7_in1() # Ponto magnetico portão leitor 1 entrada 1
        time.sleep(0.1)
        bar2 = l.leitor7_in2()  # Barreira próxima ao portão
        time.sleep(0.1)
        tx2 =  l.leitor7_in3()  # Cantato abre vindo do TX (LINEAR HCS)
        time.sleep(0.1)
        mud2 = l.leitor7_in4()  # Chave de mudança        
...
##                            evento.enviar("R","133","016")
                        ...
                        if pmg2 == 0:     # Se o portão ainda esta aberto
                            ...
                            bar2 = l.leitor7_in2() # Faz a leitura da barreira 1
                            ...
                            if bar2 == 1: # Se acionou a barreira de entrada
                                ...
                                pmg2 = l.leitor7_in1() # Faz a leitura do ponto magnetico
