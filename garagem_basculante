...
host_servidor = '172.51.7.229'  # Host servidor SEA (PHP e moni como clientes)
...
try:  # caso já exista, escreva que o sistema foi reiniciado
  ...
  with open("log_sea.txt", "a+") as arquivo: # a+ é permissão de leitura e escrita
...
def modo_manutencao(hs,data): # 
    ...
    try:
        ...
        command = ("7000 185853E60700015")  # Modo teste de funcionamento
        s.send(str.encode(command))
        reply = s.recv(1024)
        print(reply.decode('utf-8'))
    ...
    while(manutencao == 0):
        ...
        if (manutencao == 1):
            ...
            try:
                ...
                command = ("7000 185853R60700015")  # Modo teste de funcionamento
                s.send(str.encode(command))
                reply = s.recv(1024)
                print(reply.decode('utf-8'))
...
##    analog = ReadChannel(1)
##    volts = ConvertVolts(analog,1) # Mostra 1 casa decimal depois da virgula
##    print("\n")
##    print ("------------------------")
##    print("A1  {}V\n".format(volts))
##
##    analog = ReadChannel(2)
##    volts = ConvertVolts(analog,1) # Mostra 1 casa decimal depois da virgula
##    print("\n")
##    print ("------------------------")
##    print("A2  {}V\n".format(volts))
...
##    print("A5  {}V\n".format(volts))
##    
##    analog = ReadChannel(6)
##    volts = ConvertVolts(analog,1) # Mostra 1 casa decimal depois da virgula
##    print("\n")
##    print ("------------------------")
##    print("A6  {}V\n".format(volts))
##
##    analog = ReadChannel(7)
##    volts = ConvertVolts(analog,1) # Mostra 1 casa decimal depois da virgula
##    print("\n")
##    print ("------------------------")
##    print("A7  {}V\n".format(volts))
...
##    if (temperatura > 50 and temperatura < 70):
##
##        print("Resfriando processador...")
##        
...
##    if (temperatura < 50 ):
##
##        saidaB = saidaB - 0b00010000 # Desliga Cooler
##        bus.write_byte_data(MCP23017,0x015,saidaB)
##
...
def logica_inibidor(saidaA,saidaB):
    ...
    tempo_inibido = 120 # fica aberto 12 segundos com o inibidor
    verificar = 0
    stop30 = 0
    alguem_passou = 0
...
##                                s = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
##                                s.connect ((host,port))
##                                command = ("7000 185853EL0200008")  # Envia passagem saida para o moni
##                                s.send(str.encode(command))
##                                reply = s.recv(1024)
##                                print(reply.decode('utf-8'))
##                                signal.alarm(0)
...
##                            except:
##        
##                                print("Data: ",data, "Hora: ",hs,"Evento: Não enviou o evento Passagem saída")
##                            s.close()
...
##                                s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
##                                s.connect ((host,port))
##                                command = ("7000 185853EL01000008")  # Envia Entrada de veiculo para o moni
##                                s.send(str.encode(command))
##                                reply = s.recv(1024)
##                                print(reply.decode('utf-8'))
##                                signal.alarm(0)
...
##                            except:
##
##                                print("Data: ",data, "Hora: ",hs,"Evento: Não enviou o evento de Passagem Entrada")
##                                s.close()
...
##                        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
##                        s.connect ((host,port))
##                        command = ("7000 875853EL02000008")  # Envia Saida de veiculo para o moni
##                        s.send(str.encode(command))
##                        reply = s.recv(1024)
##                        print(reply.decode('utf-8'))
##                        signal.alarm(0)
...
##                    except:
##
##                        print("Data: ",data, "Hora: ",hs,"Evento: Não enviou o evento de Passagem Saida")
##                  s.close()
...
##                time.sleep(1)
##
##                aidaA = saidaA - 0b00000010 # fecha porta vidro 2
##                bus.write_byte_data(MCP23017,0x014,saidaA)
                                
                contador = 1 # Serve para não exibir a mensagem "Não esta monitorando"

                cont = 1

                #return(saidaA,saidaB)

            if (ctw1 == 1 or btn_s1 == 1): # and acesso1 == 0):
...
##                 acesso2 = 0
        ...
        if (monitorando == 0 and contador == 0):

            print ("Fim do monitoramento das portas de vidro",hora,"hs\n")
            ...
            print("Portas vidro destravadas")
